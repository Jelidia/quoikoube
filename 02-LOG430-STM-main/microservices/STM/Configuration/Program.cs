...
public class Program
{
    ...
    private static readonly string DbServerAddress = Environment.GetEnvironmentVariable("DB_SERVER_ADDRESS");
    private static readonly int DbPort = int.Parse(Environment.GetEnvironmentVariable("DB_PORT"));
    private static readonly string DbUsername = Environment.GetEnvironmentVariable("DB_USERNAME");
    private static readonly string DbPassword = Environment.GetEnvironmentVariable("DB_PASSWORD");
    private static readonly string DatabaseName = Environment.GetEnvironmentVariable("DB_NAME");
